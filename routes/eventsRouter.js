...
//import controllers
const { createEvents, allEvents, updateEvent, deleteEvent, singleEvent, upcommingEvents } = require('../controllers/eventsController');
const { isValidUser } = require('../middlewares.js/auth');

// routes
router.post('/add', upload.single("image"), isValidUser, createEvents);
router.get('/all', isValidUser, allEvents);
router.get('/upcomming', isValidUser, upcommingEvents);
